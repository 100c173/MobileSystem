<div class="modal fade" id="detailsModalEditBrand-{{$brand->id }}-{{$brand->name}}" tabindex="-1" aria-labelledby="detailsModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-3 shadow-lg border-0">
            <div class="modal-header bg-success text-white py-3">
                <h5 class="modal-title fw-bold" id="detailsModalLabel">
                    <i class="fas fa-plus"></i> Edit Brand
                </h5>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="custom-file">
                                <input class="form-control" id="name" name="name" value='{{$brand->name}}' type="text">
                            </div>
                        </div>
                    </div>
