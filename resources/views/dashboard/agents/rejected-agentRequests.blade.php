...
<div class="page-inner">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            {!! Breadcrumbs::render('agent-requests-rejected') !!}
        </ol>
    </nav>
    <div class="col-md-12">
        <div class="card">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Action Buttons">
                                        ...
                                        <button type="button" class="btn btn-outline-warning btn-sm px-3" data-bs-toggle="modal" data-bs-target="#actionModal3-{{ $agent_request->id }}" title="Take Action">
                                            <i class="fa fa-undo me-1"></i> Repending
                                        </button>
                                    </div>

                                    @include('dashboard.modals.agent-request-info')
                                    @include('dashboard.modals.agent-request-delete')
                                    @include('dashboard.modals.agent-request-repending')
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
