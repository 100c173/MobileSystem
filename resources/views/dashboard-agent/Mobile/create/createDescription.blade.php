    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body text-primary">
                <form action="{{route('agent.mobileDescriptions.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="performance_cpu" name="performance_cpu" placeholder="Enter mobile performance cpu" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail">Mobile storage desc</label>
                        <input type="text" class="form-control" id="storage_desc" name="storage_desc" placeholder="Enter mobile storage desc" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail">Mobile connectivity desc</label>
                        <input type="text" class="form-control" id="connectivity_desc" name="connectivity_desc" placeholder="Enter mobile connectivity desc" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail">Mobile battery desc</label>
                        <input type="text" class="form-control" id="battery_desc" name="battery_desc" placeholder="Enter mobile battery desc" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail">Mobile extra features</label>
                        <input type="text" class="form-control" id="extra_features" name="extra_features" placeholder="Enter mobile extra features" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail">Mobile security privacy</label>
                        <input type="text" class="form-control" id="security_privacy" name="security_privacy" placeholder="Enter mobile  security privacy" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail">Mobile security pros</label>
                        <input type="text" class="form-control" id="pros" name="pros" placeholder="Enter mobile  pros" required>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail">Mobile security cons</label>
                        <input type="text" class="form-control" id="cons" name="cons" placeholder="Enter mobile  cons" required>
                    </div>
